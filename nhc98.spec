...
nhc98 jest w pełni wyposażonym kompilatorem Haskella 98,
standardowego, leniwego, funkcyjnego języka programowania. Bazuje na
nhc13 Niklasa Röjemo, kompilatora wcześniejszej wersji tego języka.
Jest napisany w Haskellu, mały i przenośny, jego celem jest
produkowanie małych binarek, wymagających mało pamięci.
